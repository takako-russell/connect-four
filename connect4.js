...
class Game {
  ...
  endGame(msg) {
    alert(msg);
    const topRow = document.getElementById("#colum-top");
...
startBtn.addEventListener("click", () => {
  const p1Color = new Player(document.getElementById("player1").value);
  const p2Color = new Player(document.getElementById("player2").value);
